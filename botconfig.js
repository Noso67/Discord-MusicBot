module.exports = {
  ...
  Token: process.env.Token || "MTA5OTYwMTMyNDE1ODQ4ODYwOQ.Gx44AK.QwddPMgggyba043AxjWXdZxXInbmX3ynoE2eDk", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1099601324158488609", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "zSpG95Pc9vhBp4ffq6PF8-qo7l29MLp8", // Discord Client Secret
  ...
  Lavalink: {
    ...
    host: "lavalink-replit.dragon3421.repl.co", //- The host name or IP of the lavalink server.
    port: 443, // The port that lavalink is listening to. This must be a number!
    pass: "oddcoder", //- The password of the lavalink server.
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "298a0c95fb534ee2be6abd7f2af5f292", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "55e59add3ab5405fb87ca2f90c901a64", // Spotify Client Secret
  },
};
